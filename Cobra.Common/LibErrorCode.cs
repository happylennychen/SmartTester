...
namespace Cobra.Common
{
    public class LibErrorCode
    {
		...
		private const UInt32 IDS_ERR_SECTOR_HID = IDS_ERR_SECTION_COMMUNICATE + 0x00005000;
		public const UInt32 IDS_ERR_HID_BB_TIMEOUT = IDS_ERR_SECTOR_HID + 0x01;
		public const UInt32 IDS_ERR_HID_PIN_TIMEOUT = IDS_ERR_SECTOR_HID + 0x02;
		public const UInt32 IDS_ERR_HID_PROTOCOL_TIMEOUT = IDS_ERR_SECTOR_HID + 0x03;
		public const UInt32 IDS_ERR_HID_EPP_TIMEOUT = IDS_ERR_SECTOR_HID + 0x04;
		public const UInt32 IDS_ERR_HID_DRIVER_TIMEOUT = IDS_ERR_SECTOR_HID + 0x05;
		public const UInt32 IDS_ERR_HID_NMS_TIMEOUT = IDS_ERR_SECTOR_HID + 0x06;
		public const UInt32 IDS_ERR_HID_CMD_DISMATCH = IDS_ERR_SECTOR_HID + 0x07;
		public const UInt32 IDS_ERR_HID_INVALID_HANDLE = IDS_ERR_SECTOR_HID + 0x11;
		public const UInt32 IDS_ERR_HID_INVALID_PARAMETER = IDS_ERR_SECTOR_HID + 0x12;
		public const UInt32 IDS_ERR_HID_INVALID_LENGTH = IDS_ERR_SECTOR_HID + 0x13;
		public const UInt32 IDS_ERR_HID_INVALID_COMMAND = IDS_ERR_SECTOR_HID + 0x14;
		public const UInt32 IDS_ERR_HID_INVALID_BLOCK_SIZE = IDS_ERR_SECTOR_HID + 0x15;
		public const UInt32 IDS_ERR_HID_INVALID_BUFFER = IDS_ERR_SECTOR_HID + 0x16;
		public const UInt32 IDS_ERR_HID_INVALID_INDEX = IDS_ERR_SECTOR_HID + 0x17;
		public const UInt32 IDS_ERR_HID_INVALID_HARDWARE = IDS_ERR_SECTOR_HID + 0x18;
		public const UInt32 IDS_ERR_HID_BUS_ERROR = IDS_ERR_SECTOR_HID + 0x21;
		public const UInt32 IDS_ERR_HID_SLA_ACK = IDS_ERR_SECTOR_HID + 0x22;
		public const UInt32 IDS_ERR_HID_SLA_NACK = IDS_ERR_SECTOR_HID + 0x23;
		public const UInt32 IDS_ERR_HID_LOST_ARBITRATION = IDS_ERR_SECTOR_HID + 0x24;
		public const UInt32 IDS_ERR_HID_CFG_INVALID_CONFIG_TYPE = IDS_ERR_SECTOR_HID + 0x30;
		public const UInt32 IDS_ERR_HID_CFG_FREQUENCY_LIMIT = IDS_ERR_SECTOR_HID + 0x31;
		public const UInt32 IDS_ERR_HID_CFG_FREQUENCY_ERROR = IDS_ERR_SECTOR_HID + 0x32;
		#endregion
        ...
        public static string GetErrorDescription(UInt32 dwErr, bool bSpecific = true)
        {
            ...
            switch (dwErr)
            {
				...
				//Are generated by HID communication protocol
				case IDS_ERR_HID_BB_TIMEOUT:
					strErr = "Byte function timeout, cannot read/write correct byte data.";
					break;
				case IDS_ERR_HID_PIN_TIMEOUT:
					strErr = "Word function timeout, cannot read/write correct word data.";
					break;
				case IDS_ERR_HID_PROTOCOL_TIMEOUT:
					strErr = "Block function timeout, cannot read/write correct block data.";
					break;
				case IDS_ERR_HID_EPP_TIMEOUT:
					strErr = "Driver command operation time out, cannot send command through driver function.";
					break;
				case IDS_ERR_HID_DRIVER_TIMEOUT:
					strErr = "Driver timeout.";
					break;
				case IDS_ERR_HID_NMS_TIMEOUT:
					strErr = "NMS timeout.";
					break;
				case IDS_ERR_HID_CMD_DISMATCH:
					strErr = "HID adaptor command is not match, please check adaptor version or re-power it.";
					break;
				case IDS_ERR_HID_INVALID_HANDLE:
					strErr = "Invalid HID handler of driver.";
					break;
				case IDS_ERR_HID_INVALID_PARAMETER:
					strErr = "Invalid HID parameter, parameter is not supported in HID protocol";
					break;
				case IDS_ERR_HID_INVALID_LENGTH:
					strErr = "Invalid length in HID protocol, buffer length is too short.";
					break;
				case IDS_ERR_HID_INVALID_COMMAND:
					strErr = "Invalid HID command, command is not supported in HID protocol.";
					break;
				case IDS_ERR_HID_INVALID_BLOCK_SIZE:
					strErr = "Block size is too short for HID data.";
					break;
				case IDS_ERR_HID_INVALID_BUFFER:
					strErr = "Invalid buffer, buffer is not valid for saving HID data.";
					break;
				case IDS_ERR_HID_INVALID_INDEX:
					strErr = "Wrong index value in HID protocol.";
					break;
				case IDS_ERR_HID_INVALID_HARDWARE:
					strErr = "Return length has error, target device may be in error or doesn't exist.";
					break;
				case IDS_ERR_HID_BUS_ERROR:
					strErr = "HID bus error, communication is failed";
					break;
				case IDS_ERR_HID_SLA_ACK:
					strErr = "HID Slave device is ACK.";
					break;
				case IDS_ERR_HID_SLA_NACK:
					strErr = "HID Slave device is NACK.";
					break;
				case IDS_ERR_HID_LOST_ARBITRATION:
					strErr = "HID communication arbitration is lost, data may be broken.";
					break;
				case IDS_ERR_HID_CFG_INVALID_CONFIG_TYPE:
					strErr = "Invalid configuration options in HID protocol.";
					break;
				case IDS_ERR_HID_CFG_FREQUENCY_LIMIT:
					strErr = "HID frequency is out of range, HID frequency value should be between 60K~400K";
					break;
				case IDS_ERR_HID_CFG_FREQUENCY_ERROR:
					strErr = "Write HID frequency error, adaptor may have something wrong.";
					break;
